    ...
    <div class="nav-header z-999">
      <slot name="nav-header">
        ...
        >
          ...
          <img src="@images/moeys-logo.png" class="max-w-8" alt="logo">

          <Transition name="vertical-nav-app-title">
            <div v-show="!hideTitleAndIcon"
              class="text-base font-bold line-clamp-2 tracking-tight text-start text-secondary">
