...
export const { themeConfig, layoutConfig } = defineThemeConfig({
  app: {
    title: 'ប្រព័ន្ធព័ត៌មានគ្រប់គ្រងការអនុវត្តស្តង់ដាសាលារៀនគំរូ',
    logo: h('div', { innerHTML: h('img', {src: logo, class: 'w-8 h-8'}), style: 'line-height:0; color: rgb(var(--v-global-theme-primary))' }),
